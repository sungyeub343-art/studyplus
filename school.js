...
function renderDetail(schoolData) {
  ...
  document.title = `${region} ${district} ${school} 과외 | 스터디플러스`;
  document.querySelector('meta[name="description"]').setAttribute('content', `${school} 학생을 위한 ${meta.level} 학교별 내신 과외. 시험 범위와 출제 경향에 맞춘 1:1 맞춤 수업을 스터디플러스에서 상담받아보세요.`);
